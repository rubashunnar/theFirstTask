//Same code with different procedure
...
const filter_chars_and_scan =(d:any[]):any[]=>{
...
//main
PrintAll(sort(frequencies(remove_stop_words(filter_chars_and_scan(read_file("in.txt"))))))
