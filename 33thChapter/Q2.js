...
function upload_post_handler(args) {
    function create_data(filename) {
        ...
        var word_freq = {};
        //read and scan
        var word_list = fs.readFileSync(filename, 'utf8').toLowerCase().replace(/[\W_]+/g, " ").split(" ");
        //remove stop words
        var words = [];
        ...
        var sorted = Object.entries(_.fromPairs(_.sortBy(_.toPairs(word_freq), 1).reverse()));
